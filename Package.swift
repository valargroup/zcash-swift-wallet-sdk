...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/valargroup/zcash-swift-wallet-sdk/releases/download/0.10.0-voting/libzcashlc.xcframework.zip",
            checksum: "17d95d4f24a12e83883fa1157ed40cc9d72a32d39833f18da7297d0ce45a9b8f"
        )
    )
