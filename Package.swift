...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/valargroup/zcash-swift-wallet-sdk/releases/download/0.8.0-voting/libzcashlc.xcframework.zip",
            checksum: "c18b4d62704ff8973412ef0bb33eb87c639a1494e6303f40978378979728e172"
        )
    )
