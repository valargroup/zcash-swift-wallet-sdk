...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/valargroup/zcash-swift-wallet-sdk/releases/download/2.6.0-alpha.2-valar.2/libzcashlc.xcframework.zip",
            checksum: "2bd3604838fdba6071bc7d98f8c656cf2413a5d28ba578534d09346d386ea812"
        )
    )
