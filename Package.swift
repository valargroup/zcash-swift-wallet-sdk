...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/valargroup/zcash-swift-wallet-sdk/releases/download/0.7.0-voting/libzcashlc.xcframework.zip",
            checksum: "d5af958119d37c3f6ba7bca0591179f2324fa15f900299693a1a0fe01a24f014"
        )
    )
