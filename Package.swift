...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/valargroup/zcash-swift-wallet-sdk/releases/download/0.9.0-voting/libzcashlc.xcframework.zip",
            checksum: "e611d510ebf6787a87b23dd8a2b50584b5742beaa77eb1c287306cc4e39efa8d"
        )
    )
