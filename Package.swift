...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/valargroup/zcash-swift-wallet-sdk/releases/download/0.6.0-voting-2.4.10-rc1/libzcashlc.xcframework.zip",
            checksum: "1e5989293dda85d84a3c14efcc6f39c13a7d2f60d22c731daec5fc51982d2e55"
        )
    )
