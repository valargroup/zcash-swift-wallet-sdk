...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/valargroup/zcash-swift-wallet-sdk/releases/download/main-testflight-61821031/libzcashlc.xcframework.zip",
            checksum: "fd601d0e387b000be352ca57239efaf787acf778c768c06120c1187890c2fcc0"
        )
    )
